package easencriptaredecriptar;
...
public class EasencriptareDecriptar {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Texto Encripitado (Hex Form):" + cipherText);
        System.out.println("Text Descripitado:" + decryptedText);
